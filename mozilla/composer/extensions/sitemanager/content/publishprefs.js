...
function GetPublishData_internal(publishBranch, siteName)
{
  ...
  var publishData = { 
    siteName          : siteName,
    previousSiteName  : siteName,
    localPath         : GetPublishStringPref(publishBranch, prefPrefix+"local_path"),    // Kaze
    filename          : "",
    ...
    browsePrefix      : GetPublishStringPref(publishBranch, prefPrefix+"browse_prefix"), // Kaze
...
function SavePublishData_Internal(publishPrefsBranch, publishData, siteIndex)
{
  ...
  SetPublishStringPref(publishPrefsBranch, prefPrefix+"local_path",    publishData.localPath);    // Kaze
