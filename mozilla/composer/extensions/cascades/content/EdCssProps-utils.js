...
function getLocalFileURL(openOnly)
{
  ...
  var fileType = "*";
  if (openOnly)
    fp.init(window, gDialog.bundle.getString("SelectCSSFile"), nsIFilePicker.modeOpen);
  else
    fp.init(window, gDialog.bundle.getString("SelectCSSFile"), nsIFilePicker.modeSave);
