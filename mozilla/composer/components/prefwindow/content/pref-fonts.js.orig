 ...
 *    Daniel Glazman <glazman@disruptive-innovations.com>
 *
...
var fontTypes   = ["proportionalFont", "serif", "sans-serif", "cursive", "fantasy", "monospace"];
      ...
      function ( aLanguage, aFontType )
        {
          ...
          var count = { value: 0 };
          var fonts;
          if (aFontType == "proportionalFont")
          {
            aFontType = "";
            fonts = ["serif", "sans-serif"];
          }
          else
            fonts = getFontEnumerator().EnumerateFonts( aLanguage, aFontType, count );
