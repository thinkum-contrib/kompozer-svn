...
function Startup()
{
  ...
  gDialog.widthSettings = document.getElementById("widthSettings");
  gDialog.heightSettings = document.getElementById("heightSettings");
  ...
  {
    DisableAllChildren(gDialog.widthSettings);
    DisableAllChildren(gDialog.heightSettings);
    gDialog.alignGroup.disabled = true;
    gDialog.shading.disabled = true;
  }
...
function InitDialog()
{
  ...
  if(!height && !IsCSSDisabledAndStrictDTD()) {
...
function ValidateData()
{
  ...
  try {
    if (align)
      GetCurrentEditor().setAttributeOrEquivalent(globalElement, "align", align, true);
    else
