...
function Startup()
{
  ...
  gDialog.TableAlignLabel = document.getElementById("TableAlignLabel");
  gDialog.TableCaptionList = document.getElementById("TableCaptionList");
  gDialog.TableCaptionListLabel = document.getElementById("TableCaptionListLabel");
  gDialog.TableInheritColor = document.getElementById("TableInheritColor");
  gDialog.TableBGColorButton = document.getElementById("tableBackground");
  gDialog.TableBGColorLabel = document.getElementById("tableBackgroundLabel");
  ...
  gDialog.CellBackgroundButton = document.getElementById("cellBackground");
  ...
  if (tagNameObj.value == "td")
  {
    ...
    {
      SetElementEnabled(gDialog.CellHeightInput, false);
      SetElementEnabled(gDialog.CellHeightUnits, false);
      SetElementEnabled(gDialog.CellWidthInput, false);
      SetElementEnabled(gDialog.CellWidthUnits, false);
      SetElementEnabled(gDialog.TextWrapList, false);
      SetElementEnabled(gDialog.CellInheritColor, false);
      SetElementEnabled(gDialog.CellBackgroundButton, false);

      SetElementEnabled(gDialog.CellHeightCheckbox, false);
      SetElementEnabled(gDialog.CellWidthCheckbox, false);
      SetElementEnabled(gDialog.TextWrapCheckbox, false);
      SetElementEnabled(gDialog.CellColorCheckbox, false);

      SetElementEnabled(gDialog.TableAlignList, false);
      SetElementEnabled(gDialog.TableAlignLabel, false);
      SetElementEnabled(gDialog.TableBGColorButton, false);
      SetElementEnabled(gDialog.TableBGColorLabel, false);
      SetElementEnabled(gDialog.TableInheritColor , false);

      SetElementEnabled(gDialog.TableCaptionList, false);
      SetElementEnabled(gDialog.TableCaptionListLabel, false);
    }
...
function SetColor(ColorWellID, color)
{
  ...
  if (ColorWellID == "cellBackgroundCW")
  {
    if (color)
    {
      gActiveEditor.setAttributeOrEquivalent(globalCellElement, bgcolor, color, true);
  ...
  else
  {
    if (color)
    {
      gActiveEditor.setAttributeOrEquivalent(globalTableElement, bgcolor, color, true);
...
function ValidateCellData()
{
  ...
  if (gDialog.CellHAlignCheckbox.checked)
  {
    ...
    if (!gAlignWasChar)
    {
      ...
      gActiveEditor.setAttributeOrEquivalent(globalCellElement, "align", hAlign, true);
    }
  }
  ...
  if (gDialog.TextWrapCheckbox.checked)
  {
    if (gDialog.TextWrapList.value == "nowrap")
      gActiveEditor.setAttributeOrEquivalent(globalCellElement, "nowrap","nowrap", true);
    else
      try {
...
function ApplyTableAttributes()
{
  ...
  else if (newAlign != "")
  {
    ...
    {
      if (newAlign != "top")
        gActiveEditor.setAttributeOrEquivalent(gTableCaptionElement, "align", newAlign, true);
...
{
  openHelp('comp-doc-table-props','chrome://help/locale/nvu.rdf');
  return true;
}
