...
function Startup()
{
  ...
  gDialog.BackgroundImageLabel = document.getElementById("BackgroundImageLabel");
  ...
  {
    SetElementEnabled(gDialog.BackgroundImageInput, false);
    SetElementEnabled(gDialog.BackgroundImageLabel, false);
  }
...
{
  SetElementEnabledById("TextButton", !IsCSSDisabledAndStrictDTD());
  SetElementEnabledById("Text", !IsCSSDisabledAndStrictDTD());

  SetElementEnabledById("LinkButton", !IsStrictDTD());
  SetElementEnabledById("Link", !IsStrictDTD());

  SetElementEnabledById("ActiveLinkButton", !IsStrictDTD());
  SetElementEnabledById("Active", !IsStrictDTD());

  SetElementEnabledById("VisitedLinkButton", !IsStrictDTD());
  SetElementEnabledById("Visited", !IsStrictDTD());

  SetElementEnabledById("BackgroundButton", !IsCSSDisabledAndStrictDTD());
  SetElementEnabledById("Background", !IsCSSDisabledAndStrictDTD());
  ...
  {
    customLinkColor = customActiveColor = customVisitedColor = "";
  }
}
  ...
  try {
    ...
    else
    {
      ...
      if (tmpColor != "windowtext")
        editor.setAttributeOrEquivalent(globalElement, textStr, customTextColor, true);
      else
        editor.removeAttributeOrEquivalent(globalElement, textStr, true);
    ...
    if (ValidateAndPreviewImage(true))
    {
      ...
      if (gBackgroundImage)
        editor.setAttributeOrEquivalent(globalElement, backgroundStr, gBackgroundImage, true);
      else
